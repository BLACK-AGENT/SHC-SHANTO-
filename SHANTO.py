'''
1800 Subscriber Special Gift
(Enjoy your moment)
if you are not on our channel
Join https://t.me/TeamEhc_Channel
'''
#!/usr/bin/python3
...
logo="""
   \33[37;42m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌:https://t.me/EMRAN99EHCfree\33[0;m"\033[1;23m
"""
...
def main():
    ...
    print(Panel.fit("[bold green]Developer     —>>     Team Ehc"))
    print("")
    print(meth)
...
def live_ck(uid):
    Ehcemran=requests.get(f"https://thanhlike.com/modun/tool/get_facebook.php?type=checklive&id={uid}").text
    data=str(Ehcemran)
    if "live" == data.lower():
        return "Alive"
    else:
...
def file_subb(Gmail,psslist):
    global oks,done
    sys.stdout.write(f"\r  \033[38;5;46m[EHC-EMRAN] {done}|{str(len(oks))}\r");sys.stdout.flush()
